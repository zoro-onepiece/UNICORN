...
export const options = {
  ...
  tooltip: {
    enabled: true,
    theme: 'dark', // FIX: Changed from false to 'dark'
    style: {
      fontSize: '12px',
      fontFamily: undefined
    },
    x: {
      show: true, // FIX: Changed from false to true so dates show on hover
      format: 'dd MMM HH:mm', // Added hours/minutes since data is grouped by hour
      formatter: undefined,
    },
    y: {
      show: true,
